...
namespace EPS.Ui.ColorPicker
{
	...
	/// <br></br>
	/// <br></br>
	/// The set of colors displayed is controlled by the <see cref="EPS.Ui.ColorPicker.ColorSet">ColorSet</see> property.
	/// </remarks>
	public class ColorPanel : System.Windows.Forms.UserControl
	{
        ...
        internal const ColorSet defaultColorSet = EPS.Ui.ColorPicker.ColorSet.Web;
        ...
        public EPS.Ui.ColorPicker.ColorSet ColorSet
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSet", value, typeof(EPS.Ui.ColorPicker.ColorSet) );
        ...
        public EPS.Ui.ColorPicker.ColorSortOrder ColorSortOrder
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSortOrder", value, typeof(EPS.Ui.ColorPicker.ColorSortOrder) );
