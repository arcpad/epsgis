...
namespace EPS.Ui.ColorPicker
{
	...
	{
        private EPS.Ui.ColorPicker.ColorPanelWithCapture colorPanel = null;
		...
		{
            this.colorPanel = new EPS.Ui.ColorPicker.ColorPanelWithCapture();
			this.SuspendLayout();
			// 
			// colorPanel
			// 
            ...
            this.colorPanel.ColorSet = EPS.Ui.ColorPicker.ColorSet.Web;
            this.colorPanel.ColorSortOrder = EPS.Ui.ColorPicker.ColorSortOrder.Brightness;
            ...
            this.colorPanel.ColorChanged += new EPS.Ui.ColorPicker.ColorChangedEventHandler(this.colorPanel_ColorChanged);
            this.colorPanel.PanelClosing += new EPS.Ui.ColorPicker.ColorPanelClosingEventHandler(this.colorPanel_PanelClosing);
		...
		private void colorPanel_ColorChanged(object sender, EPS.Ui.ColorPicker.ColorChangedEventArgs e)
		{
