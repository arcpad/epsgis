...
namespace EPS.Ui.ColorPicker
{
	...
	/// </summary>
	/// <remarks>
	/// This control simulates a combo-box style UI but drops down a <see cref="EPS.Ui.ColorPicker.ColorPanel">ColorPanel</see>
	...
	public class ColorPicker : System.Windows.Forms.UserControl
	{
		...
		private EPS.Ui.ColorPicker.ColorSortOrder panel_colorSortOrder   = ColorPanel.defaultColorSortOrder;
		private Size                       panel_colorWellSize    = ColorPanel.defaultColorWellSize;
		private EPS.Ui.ColorPicker.ColorSet       panel_colorSet         = ColorPanel.defaultColorSet;
		...
		/// contained <see cref="EPS.Ui.ColorPicker.ColorPanel">ColorPanel</see> is displayed.
		/// </remarks>
		/// <param name="e"></param>
		...
		/// <see cref="EPS.Ui.ColorPicker.ColorPanel">ColorPanel</see> control.<br></br><br></br>
		/// See <see cref="EPS.Ui.ColorPicker.ColorSet">ColorSet</see>.
		/// </summary>
		...
		public EPS.Ui.ColorPicker.ColorSet ColorSet
		{
			get
			{
		...
		/// <see cref="EPS.Ui.ColorPicker.ColorPanel">ColorPanel</see> should be sorted.<br></br><br></br>
		/// See <see cref="EPS.Ui.ColorPicker.ColorSortOrder">ColorSortOrder</see>.
		/// </summary>
		...
		public EPS.Ui.ColorPicker.ColorSortOrder ColorSortOrder
		{
			get
			{
