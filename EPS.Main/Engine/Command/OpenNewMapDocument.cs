...
namespace EPS.Engine.Command
{
  ...
  [ProgId("com.qhsw.OpenNewMapDocument")]
  public sealed class OpenNewMapDocument : BaseCommand
  {
    ...
    public OpenNewMapDocument(ControlsSynchronizer controlsSynchronizer)
    {
      ...
      try
      {
          base.m_bitmap = Properties.Resources.OpenNewMapDocument;
          // EPS.Resources.OpenNewMapDocument global::EPS::
